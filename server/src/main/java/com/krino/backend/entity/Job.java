...
public class Job extends AbstractPublicEntity {
    ...
    /**
     * Human-readable internal reference, such as JOB-2026-0042.
     * Generated by the application service.
     */
    @NotBlank
    @Size(max = 50)
    ...
    /**
     * Candidate-facing URL value, such as:
     * senior-java-engineer-casablanca
     */
    @NotBlank
    @Size(max = 180)

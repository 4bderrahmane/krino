...
public class JobController {
    ...
    public ResponseEntity<JobResponseDTO> updateJob(@PathVariable("publicId") UUID publicId,
    ...
    @PreAuthorize("hasAuthority('CAN_UPDATE_JOB')")
    public ResponseEntity<JobResponseDTO> patchJob(@PathVariable("publicId") UUID publicId,
                                                   @Valid @RequestBody JobUpdateDTO jobUpdateDTO) {
